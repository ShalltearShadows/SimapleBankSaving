...
<div class="content">
    <div id="pane" class="flip">
        <div id="login" class="front">
            <form action="AdminLoginServlet" onsubmit="return checkcode();" class="container">
                <h2>Admin Login</h2>
                <div class="row100">
                    <div class="col">
                        <div class="inputBox">
                    ...
                    <div class="col">
                        <div class="inputBox">
                            <input type="password" name="apwd" required="required">
        ...
        <div id="register" class="back">
            <form action="AdminRegisterServlet"  class="container" method="post">
                ...
                <div class="row100">
                    ...
                    <div class="col" style="top:25px;">
                        <div class="inputBox" >
                            <input type="text" name="aphone" required="required">
