        ...
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <ul id="userMeun" class="nav nav-list collapse menu-second">
                    <li><a href="###" onclick="showAtRight('${pageContext.request.contextPath}/manage-infomation/manageInfo.jsp')"><i class="fa fa-users"></i> 查看个人信息</a></li>
                </ul>
                ...
                <li><a href="#teaMeun" class="nav-header menu-first collapsed" data-toggle="collapse">
                    <i class="fa fa-cogs"></i>&nbsp; 教师信息管理 </a>
                </li>
                <ul id="teaMeun" class="nav nav-list collapse menu-second">
                    <li><a href="###" onclick="showAtRight('${pageContext.request.contextPath}/manage-infomation/allteacher.jsp')"><i class="fa fa-cog"></i> 查看教师信息</a></li>
                    <li><a href="###" onclick="showAtRight('${pageContext.request.contextPath}/manage-infomation/addteacher.jsp')"><i class="fa fa-cog"></i> 添加教师账号</a></li>
                    <li><a href="###" onclick="showAtRight('${pageContext.request.contextPath}/manage-infomation/deleteteacher.jsp')"><i class="fa fa-cog"></i> 删除教师账号</a></li>
                    <li><a href="###" onclick="showAtRight('${pageContext.request.contextPath}/manage-infomation/alterteacher.jsp')"><i class="fa fa-cog"></i> 修改教师信息</a></li>
                </ul>
                ...
                <ul id="idMeun" class="nav nav-list collapse menu-second">
                    <li><a href="###" onclick="showAtRight('${pageContext.request.contextPath}/manage-infomation/altergname.jsp')"><i class="fa fa-cog"></i> 修改名字</a></li>
                    <li><a href="###" onclick="showAtRight('${pageContext.request.contextPath}/manage-infomation/altergpwd.jsp')"><i class="fa fa-cog"></i> 修改密码</a></li>
                </ul>
...
<%
    ...
    String deltnum = request.getParameter("delt");
    int k = 0;
    if(!(delnum==null)){
        StudentDAO.deleteStudentByID(delnum);
        k = 1;
    }else if (!(deltnum==null)){
        TeacherDAO.deleteTeacherByID(deltnum);
        k = 1;
    }
